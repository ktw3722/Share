...
<DIV align="left" style="color: #3366cc;font-weight: bold;margin-left: 40px">약관 동의</DIV><br>
...
<div style="text-align: center"> 
  <label><input type="checkbox" name="agree" value="1" > 약관에 동의합니다</input></lable><br><br>
  <input id='button' type="submit" value="회원가입"></input>  

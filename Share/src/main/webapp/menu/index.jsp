...
<body>
	...
	<div id="content">
		<div id="logo" style="text-align: center; margin: 0px">
			<img alt="logo" src="${pageContext.request.contextPath}/image/로고.png"
				width="200px">
		</div>
		<div id="carpool">
			...
			<form style="text-align: center;">
				...
				<div class="search_wrap">
					<div>
						<img src="${pageContext.request.contextPath}/image/ico_start.gif"
							title="출발지" alt="출발지" width="12px" height="20px"> <input
							name="src_key_1" value="" title="출발지를 입력해주세요" size="10"
							maxlength="100"
							style="border: none; border: 1px solid #d8d8d8; width: 40%; height: 35px">
						<img
							src="${pageContext.request.contextPath}/image/ico_arrival.gif"
